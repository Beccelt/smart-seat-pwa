...
//  Serial.println("ADC1: " + String(fsrADC1));
//  Serial.println("ADC2: " + String(fsrADC2));
//  Serial.println("ADC3: " + String(fsrADC3));
...
//    Serial.println("Resistance 1: " + String(fsrR1) + "g");
//    Serial.println("Resistance 2: " + String(fsrR2) + "g");
//    Serial.println("Resistance 3: " + String(fsrR3) + "g\n");
